...
<div class="max-w-4xl mx-auto px-4">
    ...
    <div class="bg-[#252536] rounded-2xl p-5 mb-6 border border-[#FB773C]/50">
      ...
      >
        <div class="flex items-center gap-3">
          <div
            class="w-12 h-12 bg-[#FB773C]/20 rounded-xl flex items-center justify-center"
          >
            <svg
        ...
        {#if sdoCanTakeAttendance}
          <a
            href="/sdo/appello"
            class="inline-flex items-center justify-center bg-[#FB773C] hover:bg-[#EB3678] text-white font-semibold py-2.5 px-5 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-[#FB773C]/20"
          >
            Fai l'appello
          </a>
        {/if}
  ...
  {:else if corsi.length === 0}
    ...
    >
      ...
      <a
        href="/studente/corsi"
        class="inline-flex items-center gap-2 bg-[#FB773C] hover:bg-[#EB3678] text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200"
      >
        Sfoglia i corsi
      </a>
    </div>
      ...
      {#each Object.entries(coursesPerDay) as [day, dayCourses] (day)}
        ...
        >
          <div class="bg-[#FB773C]/10 border-b border-gray-700/50 px-5 py-3">
            <h3 class="text-lg font-semibold text-[#FB773C]">
              {giorni[parseInt(day)] || `Giorno ${parseInt(day) + 1}`}
            </h3>
          </div>
