...
>
    <h1 class="text-3xl font-bold text-center text-[#FB773C] mb-8">Tieni un corso? Accedi qui</h1>
            <p class="text-gray-500 text-sm mt-2 mb-6 px-4 py-2 bg-gray-100 rounded-lg shadow-sm">
                Ti verranno date delle credenziali per accedere al pannello di gestione dei corsi e delle iscrizioni.
            </p>
